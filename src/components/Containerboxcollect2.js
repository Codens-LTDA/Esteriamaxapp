...
const Containerboxcollect2 = ({ box, navigation, client, departament, myref }) => {
    ...
    return (
        <>
            <TouchableOpacity style={styles.boxes} onPress={clickOut}>
                <View style={box.his_status === '3' ? styles.viewtext2 : styles.viewtext} ref={myref}>
                    <View style={styles.sideleft}>
                        <FontAwesomeIcon icon={faBox} size={27} style={styles.iconbox} />
                        <Text style={styles.textbox}>{box.caixa}</Text>
                    </View>
                    <View style={styles.sideright}>
                        <Countitenscollect client={client} departament={departament} />
                    </View>
                </View>
                <View style={openbox === true ? styles.openbox : styles.box}>
                    {
                        openbox === true ?
                            (
                                <Request client={client} departament={departament} idbox={box.cnt_id}/>
                            )
                            :
                            null
                    }
...
export default Containerboxcollect2;